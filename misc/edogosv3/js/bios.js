...
async function populateLiveMedia() {
    ...
    const essentialFiles = [
        ...
        { webPath: 'icons/16/text-editor.png', fsPath: '/usr/share/icons/16/text-editor.png' },
        { webPath: 'icons/16/media-player.png', fsPath: '/usr/share/icons/16/media-player.png' },
        { webPath: 'icons/16/terminal.png', fsPath: '/usr/share/icons/16/terminal.png' },
        { webPath: 'icons/16/settings.png', fsPath: '/usr/share/icons/16/settings.png' },
        { webPath: 'icons/16/settings-backgrounds.png', fsPath: '/usr/share/icons/16/settings-backgrounds.png' },
        { webPath: 'icons/16/settings-about.png', fsPath: '/usr/share/icons/16/settings-about.png' },
        { webPath: 'icons/16/writer.png', fsPath: '/usr/share/icons/16/writer.png' },
        { webPath: 'icons/16/info.png', fsPath: '/usr/share/icons/16/info.png' },
        { webPath: 'icons/16/applications-games.png', fsPath: '/usr/share/icons/16/applications-games.png' },
        { webPath: 'img/cheeky_man.png', fsPath: '/usr/share/icons/edogos-logo.png' },
        // Wallpapers
