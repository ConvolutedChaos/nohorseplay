...
(function () {
    ...
    const APP_REGISTRY = [
        ...
        },
        {
            ...
            action: () => openCustomAppFromPath("/usr/bin/writer.app"),
        },
        {
            name: 'Text Editor',
            icon: '/usr/share/icons/32/text-editor.png',
